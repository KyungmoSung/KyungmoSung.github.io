...
[Setup - fastlane docs](https://docs.fastlane.tools/getting-started/ios/setup/)
...
![Untitled](/img/xcode-scrollview/Untitled.png)

App Store Connect에도 빌드가 정상적으로 업로드 완료되었습니다!

![Untitled](/img/xcode-scrollview/Untitled%201.png)
...
<aside>
💡 자세한 메타데이터는 링크를 확인하세요

[https://docs.fastlane.tools/actions/upload_to_app_store/](https://docs.fastlane.tools/actions/upload_to_app_store/)
...
![Untitled](/img/xcode-scrollview/Untitled%202.png)
...
![Untitled](/img/xcode-scrollview/Untitled%203.png)
